...
async def home(client, message):
  buttons = [[
    ...
    [
        InlineKeyboardButton('Our Channel', url='http://telegram.me/MORAGLINKS'),
        InlineKeyboardButton('Source Code', url='https://github.com/r0ld3x/MORAG-TELEGRAPH-BOT')
    ]]
...
Made With Love By @MORAGLINKS</b>""",
